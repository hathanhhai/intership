<div class="banner-bootom-w3-agileits">
	<div class="container">
		...
		<div class="col-md-8 products-right">
			<h5><?php echo $getNameKind; ?> <span>có (<?php echo $countProduct; ?>) sản phẩm</span></h5>
   ...
   <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img style="width:255px;height:291px;" src="Uploads/<?php echo $item->Hinh ?>" alt="" class="pro-image-front"><img src="Uploads/<?php echo $item->Hinh ?>" alt="" style="height:300px" class="pro-image-back">
