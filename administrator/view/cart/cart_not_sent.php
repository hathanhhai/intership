                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX" align="center">
                                ...
                                <td class="center"><i  class="fa fa-check"></i><a onClick="return confirm('Bạn có chắc Đã kiểm tra đơn hàng này')" href="cart_confirm.php?id=<?php echo $item->ID ?>"> Duyệt</a></td>
