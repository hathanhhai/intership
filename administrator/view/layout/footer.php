	...
	<script src="public/admin/js/myjs.js"></script>
  ...
  <script>    CKEDITOR.replace( 'editor1' );</script>
    ...
    $(document).ready(function() {
		...
		$("#checkyes").click(function(){
			...
			$("#formgiagiam").show(100);
			
		})
		
		$("#checkno").click(function(){
			
			$("#formgiagiam").hide(100);
			
		})
		
		$("#selectKind").blur(function(){
			
			var idkind = $(this).val();
			$.post("ajax/a_category.php?id="+idkind,function(data){
					$("#selectCat").html(data);
					//alert(data);
				})
